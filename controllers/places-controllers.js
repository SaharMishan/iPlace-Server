...
// place.toObject({getters: true}) => turn to object and getters take the _id and make a id field
...
const deletePlace = async (req, res, next) => {
  ...
  try {
    const sess = await mongoose.startSession();
    sess.startTransaction();
    await place.deleteOne({ session: sess }).exec();
    place.creator.places.pull(place); // remove the place id
